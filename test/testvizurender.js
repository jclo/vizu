...
export default function(dom) {
  describe('Test the method render() with a wrong template passed in:', () => {
  ...
  describe('Test the method render() with only a template argument passed in:', () => {
    it('Expects the method to return null.', () => {
  ...
  describe('Test the method render() without any Web Component passed in:', () => {
    it('Expects the method to return null.', () => {
      const view = Vizu.render(
        '<div></div>',
        null,
  ...
  describe('Test the method render() with the Web Component Aaa passed in:', () => {
    const view = Vizu.render(
      '<Aaa />',
      { '<Aaa />': Aaa },
