...
export default function(dom) {
  describe('Test the method render() with a Web Component surrounded by the div tag:', () => {
  ...
  describe('Test the method render() with a Web Component surrounded by the header tag:', () => {
    const view = Vizu.render(
      '<Bbb />',
      { '<Bbb />': Bbb },
  ...
  describe('Test the method render() with a Web Component surrounded by the footer tag:', () => {
    const view = Vizu.render(
      '<Ccc />',
      { '<Ccc />': Ccc },
  ...
  describe('Test the method render() with a Web Component surrounded by the article tag:', () => {
    const view = Vizu.render(
      '<Ddd />',
      { '<Ddd />': Ddd },
