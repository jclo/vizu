...
export default function(dom) {
  describe('Test Vizu methods (next):', () => {
    //
    describe('Test the method Vizu.render() with the Web Component Bbb passed in:', () => {
    ...
    describe('Test the method Vizu.render() with the Web Component Ccc passed in:', () => {
      const view = Vizu.render(
        '<Ccc />',
        { '<Ccc />': Ccc },
  ...
  describe('Test the method Vizu.render() with a Web Component passed in but no element to attach it:', () => {
    it('Expects the method to return an object.', () => {
      const view = Vizu.render(
        '<Aaa />',
        { '<Aaa />': Aaa },
